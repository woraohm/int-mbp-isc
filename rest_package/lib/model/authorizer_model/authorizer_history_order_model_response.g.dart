...
part of 'authorizer_history_order_model_response.dart';
...
AuthorizerHistoryOrderModelResponse
    _$AuthorizerHistoryOrderModelResponseFromJson(Map<String, dynamic> json) {
  return AuthorizerHistoryOrderModelResponse(
...
Map<String, dynamic> _$AuthorizerHistoryOrderModelResponseToJson(
        AuthorizerHistoryOrderModelResponse instance) =>
    <String, dynamic>{
