...
part of 'authorizer_list_order_model_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AuthorizerListOrderModelResponse _$AuthorizerListOrderModelResponseFromJson(
    Map<String, dynamic> json) {
  return AuthorizerListOrderModelResponse(
...
Map<String, dynamic> _$AuthorizerListOrderModelResponseToJson(
        AuthorizerListOrderModelResponse instance) =>
    <String, dynamic>{
