...
part of 'authorizer_approvel_order_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AuthorizerApprovelOrderResponse _$AuthorizerApprovelOrderResponseFromJson(
    Map<String, dynamic> json) {
  return AuthorizerApprovelOrderResponse(
...
Map<String, dynamic> _$AuthorizerApprovelOrderResponseToJson(
        AuthorizerApprovelOrderResponse instance) =>
    <String, dynamic>{
