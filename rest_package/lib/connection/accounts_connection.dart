...
class AccountsConnection extends AbstractConnection{

  AccountsConnection(String url, String port) : super(url, port);

  Future<http.Response> connectAccounts(AccountsRequest request, String token){
    final endpoint = "mbp-rest/service/accounts";
