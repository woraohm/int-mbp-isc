...
class DeleteGroupConnection extends AbstractConnection{

  DeleteGroupConnection(String url, String port) : super(url, port);

  Future<http.Response> connectDeleteGroup(DeleteGroupRequest request, String token){
    final endpoint = "mbp-rest/service/deleteGroup";
