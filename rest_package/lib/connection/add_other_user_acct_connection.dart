...
class AddOtherUserAcctConnection extends AbstractConnection{

  AddOtherUserAcctConnection(String url, String port) : super(url, port);

  Future<http.Response> connectAddOtherUserAcct(AddOtherUserAcctRequest request, String token){
    final endpoint = "mbp-rest/service/addOtherUserAccount";
