...
class CheckerCheckOrderConnection extends AbstractConnection{

  CheckerCheckOrderConnection(String url, String port) : super(url, port);

  Future<http.Response> connectCheckerCheckOrder(CheckerCheckOrderRequest request, String token){
    final endpoint = "mbp-rest/service/checkerCheckOrder";
