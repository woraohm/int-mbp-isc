...
class CheckerHistoryDetailConnection extends AbstractConnection{

  CheckerHistoryDetailConnection(String url, String port) : super(url, port);

  Future<http.Response> connectCheckerHistoryDetail(CheckerHistoryDetailRequest request, String token){
    final endpoint = "mbp-rest/service/checkerHistoryDetail";
