...
class OSTDTotalConnection extends AbstractConnection{

  OSTDTotalConnection(String url, String port) : super(url, port);

  Future<http.Response> connectOSTDTotal(OSTDTotalRequest request, String token){
    final endpoint = "mbp-rest/service/totalCompanyAssets";
