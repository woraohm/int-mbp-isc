...
class LogoutConnection extends AbstractConnection{

  LogoutConnection(String url, String port) : super(url, port);

  Future<http.Response> connectLogout(LogoutRequest request, String token){
    final endpoint = "mbp-rest/auth/logout";
