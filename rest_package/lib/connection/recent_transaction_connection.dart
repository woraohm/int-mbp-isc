...
class RecentTransactionConnection extends AbstractConnection{

  RecentTransactionConnection(String url, String port) : super(url, port);

  Future<http.Response> connectRecentTransaction(RecentTransactionRequest request, String token){
    final endpoint = "mbp-rest/service/recentTransaction";
