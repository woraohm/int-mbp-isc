...
class FavouriteAcctConnection extends AbstractConnection{

  FavouriteAcctConnection(String url, String port) : super(url, port);

  Future<http.Response> connectFavouriteAcct(FavouriteAcctRequest request, String token){
    final endpoint = "mbp-rest/service/favoriteAccount";
