...
class AuthorizerCheckTransfConnection extends AbstractConnection{

  AuthorizerCheckTransfConnection(String url, String port) : super(url, port);

  Future<http.Response> connectAuthorizerCheckTransf(AuthorizerCheckTransfRequest  request, String token){
    final endpoint = "mbp-rest/service/authorizerCheckTransfer";
