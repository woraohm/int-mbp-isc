...
class AuthorizerListOrderConnection extends AbstractConnection{

  AuthorizerListOrderConnection(String url, String port) : super(url, port);

  Future<http.Response> connectAuthorizerListOrder(AuthorizerListOrderRequest  request, String token){
    final endpoint = "mbp-rest/service/authorizerListOrder";
