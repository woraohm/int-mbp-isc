...
class CreateGroupConnection extends AbstractConnection{

  CreateGroupConnection(String url, String port) : super(url, port);

  Future<http.Response> connectCreateGroup(CreateGroupRequest request, String token){
    final endpoint = "mbp-rest/service/createGroup";
