...
class SelectGroupConnection extends AbstractConnection{

  SelectGroupConnection(String url, String port) : super(url, port);

  Future<http.Response> selectGroupConnection(SelectGroupRequest request, String token){
    final endpoint = "mbp-rest/service/selectGroup";
