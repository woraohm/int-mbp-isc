...
class AddFavouriteAcctConnection extends AbstractConnection{

  AddFavouriteAcctConnection(String url, String port) : super(url, port);

  Future<http.Response> connectAddFavouriteAcct(AddFavouriteAcctRequest request, String token){
    final endpoint = "mbp-rest/service/addFavAcct";
