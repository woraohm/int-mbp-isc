...
class GraphConnection extends AbstractConnection{

  GraphConnection(String url, String port) : super(url, port);

  Future<http.Response> connectGraph(GraphRequest request, String token){
    final endpoint = "mbp-rest/service/balanceAcctType";
