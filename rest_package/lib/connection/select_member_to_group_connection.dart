...
class SelectMemberToGroupConnection extends AbstractConnection{

  SelectMemberToGroupConnection(String url, String port) : super(url, port);

  Future<http.Response> selectMemberToGroupConnection(SelectMemberToGroupRequest request, String token){
    final endpoint = "mbp-rest/service/selectMember";
