...
class TransfOrderConnection extends AbstractConnection{

  TransfOrderConnection(String url, String port) : super(url, port);

  Future<http.Response> transfOrderConnection(TransfOrderRequest request, String token){
    final endpoint = "mbp-rest/service/transactionTxSingle";
