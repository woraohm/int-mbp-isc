...
class OtherUserAcctConnection extends AbstractConnection{

  OtherUserAcctConnection(String url, String port) : super(url, port);

  Future<http.Response> connectOtherUserAcct(OtherUserAcctRequest request, String token){
    final endpoint = "mbp-rest/service/otherUserAccounts";
