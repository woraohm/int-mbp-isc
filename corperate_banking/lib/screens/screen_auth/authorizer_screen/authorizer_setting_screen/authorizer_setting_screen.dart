...
class AuthorizerSettingScreen extends StatefulWidget {
  @override
  _AuthorizerSettingScreenState createState() => _AuthorizerSettingScreenState();
}

class _AuthorizerSettingScreenState extends State<AuthorizerSettingScreen> {
      ...
      child: InkWell(
        onTap: ()=>func.logOut(context),
          ...
          decoration: BoxDecoration(
              color: backgroundMainColor, borderRadius: BorderRadius.circular(20)),
          child: Text(
            'ออกจากระบบ',
            style: TextStyle(
